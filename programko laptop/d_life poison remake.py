...
def in_poison_step(main_cell):
    dead = [3, 4, 5]
    clear = 6
    if main_cell in dead:
        return main_cell + 1
...
def evolution_step(position: Position, state: State,
    ...
    for element in neighbors_all:
        if element in poison or position in poison:
            return in_poison_step(main_cell)
            # if (main_cell in dead and main_cell != 6) \
            #         and main_cell is not None:
            #     return main_cell + 1
            # elif main_cell == clear:
            #     return None
            # else:
    ...
    #     return in_poison_step(main_cell)
        ...
        # if main_cell in dead and main_cell != 6 and main_cell is not None:
        #     return main_cell + 1
        # elif main_cell == clear:
        #     return None
        # else:
    ...
    if main_cell in alive and main_cell:
        if neighbors_alive >= 3 and neighbors_alive <= 5:
            return main_cell
        else:
            return 3
    elif main_cell in dead and main_cell is not None:
        return main_cell + 1
    elif main_cell == clear and main_cell is not None:
        return None
...
def evolve(initial: State, poison: set[Position],
    ...
    for _ in range(generations):
        ...
        for element in born:
            ...
            if (able_of_birth == 1 or
                    able_of_birth == 2) and element not in all_pos:
                all_pos.add(element)
...
# state = {(967, 967): 1, (963, 963): 6, (964, 965): 2, (966, 966): 5, (968, 964): 2, (968, 966): 2, (968, 963): 2, (963, 965): 1, (964, 966): 1, (964, 967): 4, (966, 967): 2, (966, 964): 1}
# poison = {(963, 967), (964, 963), (965, 963), (965, 964), (966, 968)}
# print(evolve(state, poison, 1))
