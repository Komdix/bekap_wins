...
-- tu som pridavam keymap na ctrl backspace....

-- vim.keymap.set('i', '<ctlr>')
...
-- [[ Basic Autocommands ]]
--  See `:help luka-guide-autocommands`
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- Think of <c-l> as mmp.mapping(function()
